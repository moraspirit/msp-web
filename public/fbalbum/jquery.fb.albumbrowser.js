...
(function ($) {
    $.fn.FacebookAlbumBrowser = function (options) {
        var defaults = {
            ...
            albumsPageSize: 0,
            albumsMoreButtonText: "see more",
            photosPageSize: 0,
            photosMoreButtonText: "see more",
            checkedPhotos: []
        }
                    ...
                    success: function (result) {
                        if ($(result.data).length > 0) {
                            ...
                            for (a = 0; a < $(result.data).length; a++) {
                                ...
                                // exclude non slug albums
                                if(!$(result.data).get(a).name.match(/slug/i)){
                                    continue;
                                }
